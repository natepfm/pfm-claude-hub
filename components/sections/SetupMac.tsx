    ...
    <section id="setup-mac" className="my-20 scroll-mt-8">
      ...
      <div className="my-8">
        ...
        <p className="text-muted mb-3">
          Installs Homebrew, Git, Node, Higgsfield CLI, ffmpeg (so Claude can read video file metadata), Python's openpyxl, and copies all PFM skills + settings from Lucid Link in one command.
        </p>
