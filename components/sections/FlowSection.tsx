const stages = [
  ...
  },
  {
    ...
    skills: ["ag.stage", "ag.broll.iphone", "vsl-state-variations", "pixar-state-music-video", "breaking-news-story-ads", "podcast-guest-veo", "call-graphics", "veo-life", "+ more"],
    hub: true,
  },
  {
    n: "04",
                ...
                {s.hub && (
                  <div className="mt-4 grid sm:grid-cols-2 gap-3">
                    ...
                    <div className="p-4 bg-tintBlue border border-ink">
                      <div className="text-sm font-semibold text-text">💻 Local fire · manual</div>
                      <div className="text-xs text-muted mt-0.5">You fire in your own session — <span className="font-mono text-accentDeep">/ag.stage</span>, then pick <strong className="text-text">Generate locally</strong> at the routing fork.</div>
                    </div>
                  </div>
                )}
