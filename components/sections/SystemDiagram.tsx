  ...
  return (
    <div
      className={`flex items-center gap-2.5 rounded-lg px-3 py-2.5 flex-1 ${
        highlight ? "bg-accentMuted ring-1 ring-accent/60" : "bg-surface/60 ring-1 ring-border/60"
      }`}
    >
      <span className="grid place-items-center w-6 h-6 rounded-full bg-accent text-bg text-xs font-bold shrink-0">
        {n}
      </span>
...
export default function SystemDiagram() {
  return (
    <section id="how-it-works" className="my-12 scroll-mt-8">
      <div className="rounded-xl bg-glass-light backdrop-blur-xl shadow-elev1 ring-1 ring-white/10 p-5 md:p-6">
        <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1 mb-4">
          <div className="text-xs uppercase tracking-widest text-accent">Reference</div>
        ...
        <p className="text-xs text-muted mt-4">
          ...
          <a href="#skills" className="text-accent hover:text-accentHover underline">
            Skills
          </a>{" "}
          below.
        </p>
