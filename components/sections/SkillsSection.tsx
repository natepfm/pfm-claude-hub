    ...
    <section id="skills" className="my-20 scroll-mt-8">
      ...
      <div className="my-8">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          {tasks.map((t) => (
            <div key={t.goal} className="rounded-lg p-4 bg-surface-gradient shadow-elev1 ring-1 ring-ink hover:shadow-elev2 hover:-translate-y-0.5 hover:ring-accent/50 transition-all duration-200">
      ...
      <div className="mt-14 mb-8">
        <h3 className="text-xl font-bold mb-6 pb-2 border-b border-border">Every skill, by category</h3>
        <div className="space-y-10">
          {categoryOrder
            ...
            .map((cat) => {
              ...
              return (
                <div key={cat}>
                  <div className="flex items-baseline gap-3 flex-wrap mb-4 pb-2 border-b border-border">
                    <h4 className="text-lg font-bold text-accent">{categoryLabels[cat] ?? cat}</h4>
      ...
      <div className="my-8 rounded-lg p-6 bg-accentMuted shadow-glow-accent ring-1 ring-accent/40">
        <div className="flex items-start justify-between gap-6 flex-wrap">
          ...
          <a
            ...
            download
            className="inline-flex items-center gap-2 px-5 py-3 bg-accent text-white font-semibold rounded hover:bg-accentHover transition-colors whitespace-nowrap"
          >
            ⬇ Download .plugin
          </a>
        </div>
      ...
      <div className="my-8 rounded-lg p-6 bg-accentMuted shadow-glow-accent ring-1 ring-accent/40">
        <div className="text-xs font-mono uppercase tracking-[0.08em] text-accentDeep mb-2">Contribute</div>
        <h3 className="font-heading font-bold text-xl mb-2">Found a workflow worth a skill? Propose it.</h3>
        <p className="text-sm text-muted leading-relaxed">
